angular.module('digdeepApp.servicesESCtrl', [])

.config(['$stateProvider', function ($stateProvider) {
	$stateProvider.state('servicesES', {
		url: '/servicesES',
		templateUrl: '/app/templates/servicesES.html',
		controller: 'servicesESCtrl',
		params: {
        	idDigdeeper: ""
    	}
	})
...
.controller('servicesESCtrl', [ '$scope', '$state', '$rootScope', 'serviceService', '$localStorage','categoryService', '$interval','userService',
