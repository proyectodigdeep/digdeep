...
exports.getTimesForRangeDateByDigdeeper = function(id, dateInit, dateFinal, onSuccess, onError) {
    calendarRepository.getTimesForRangeDateByDigdeeper(id, dateInit, dateFinal, onSuccess, onError)
}
